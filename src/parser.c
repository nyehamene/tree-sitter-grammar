...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [28] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_alternative, 3, 0, 2),
  [30] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_alternative, 3, 0, 2),
  ...
  [50] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_repeatition, 3, 0, 0),
  [52] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_repeatition, 3, 0, 0),
  ...
  [58] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_option, 3, 0, 0),
  [60] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_option, 3, 0, 0),
  [62] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_group, 3, 0, 0),
  [64] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_group, 3, 0, 0),
