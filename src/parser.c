...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [9] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__production, 2, 0, 0), SHIFT_REPEAT(2),
  ...
  [25] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__production, 2, 0, 0), SHIFT_REPEAT(2),
  [28] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__production, 2, 0, 0), SHIFT_REPEAT(22),
  [31] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_alternative, 3, 0, 3),
  [33] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_alternative, 3, 0, 3),
  ...
  [75] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_repeatition, 3, 0, 0),
  [77] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_repeatition, 3, 0, 0),
  [79] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_option, 3, 0, 0),
  [81] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_option, 3, 0, 0),
  [83] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_group, 3, 0, 0),
  [85] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_group, 3, 0, 0),
  [87] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_identifier_extern, 3, 0, 2),
  [89] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_identifier_extern, 3, 0, 2),
  ...
  [95] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(20),
  [98] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_production_definition, 4, 0, 1),
